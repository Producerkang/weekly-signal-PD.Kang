(()=>{
 ...
 const source=window.WEEKLY_SIGNAL_LIFE_PHOTO_V20;
 ...
 if(footerKicker)footerKicker.textContent='WEEKLY SIGNAL · ISSUE 01 · EDITORIAL MODEL V20';
 document.documentElement.dataset.contentEdition='issue-01-editorial-v20';
})();
